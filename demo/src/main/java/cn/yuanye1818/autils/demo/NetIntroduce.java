package cn.yuanye1818.autils.demo;
...
public class NetIntroduce {
    ...
    public static class MainActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            api.m("userBack");// 指定回调函数的名称，默认为网络请求的名称(比如，Net.user创建的api，这个默认的名字就是user)，非必须，只要针对给回调方法起别名的需求
        ...
        //回调1
        @NetBack
        public void user(Throwable error, Response<ResponseBody> response) {
        ...
        public void user(String messsage, @BackType User user) {
        }
     ...
     *
     **************************************************/
    public static class BeanBack<U> implements NetBackI {
        @Override
        ...
        public void back(String messsage, NetIntroduce.User user) {
        }
