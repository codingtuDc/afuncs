package cn.yuanye1818.autils.core.ls;
...
import cn.yuanye1818.autils.core.ls.each.Each;
import cn.yuanye1818.autils.core.ls.each.FilterEach;
import cn.yuanye1818.autils.core.ls.each.MapEach;
import cn.yuanye1818.autils.core.ls.each.MapFilterEach;
import cn.yuanye1818.autils.core.ls.filter.Filter;
import cn.yuanye1818.autils.core.ls.filter.MapFilter;

import static cn.yuanye1818.autils.core.utils.CollectionFunc.count;
...
public class Ls {
    ...
    public static <K, T> void ls(Map<K, ? extends T> ts, MapFilter<K, T> filter,
            MapFilterEach<K, T> each) {
        if (count(ts) > 0) {
